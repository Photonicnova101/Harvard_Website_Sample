...
placeBtn.onclick = function(){
 	...
 	// get a reference to the box
        ...
        var yPosition = Math.random() * (0 - height) + height; // should generate a value between 0 and the height
        var xPosition = Math.random() * (0 - width) + width;  //should generate a value between 0 and the width
